module m_problem
    ...
    subroutine p_make_fraptran (this, ifilename, rfilename, ofilename, frapmode)
        ...
        call this % frod % set_i4_0 ('totnb', int(totnb))
        ...
        call this % frod % set_r8_0 ('opf', OpenPorosityFraction)
        ...
        call this % frod % set_r8_0 ('scd', scd(1))
        call this % frod % set_r8_1 ('azpang', azpang(1:naxn))
        call this % frod % set_r8_1 ('htclev', htclev(1:naxn))
        call this % frod % set_r8_1 ('ExtentOfBow', ExtentOfBow(1:naxn))
        call this % frod % set_r8_0 ('vplen', vplen(1))
        call this % frod % set_r8_1 ('gadoln', gadoln(1:naxn))
        call this % frod % set_r8_0 ('gfrac-he', gfrac(1))
        call this % frod % set_r8_0 ('gfrac-ar', gfrac(2))
        call this % frod % set_r8_0 ('gfrac-kr', gfrac(3))
        call this % frod % set_r8_0 ('gfrac-xe', gfrac(4))
        call this % frod % set_r8_0 ('gfrac-h' , gfrac(5))
        call this % frod % set_r8_0 ('gfrac-n' , gfrac(6))
        call this % frod % set_r8_0 ('gfrac-air', gfrac(7))
        call this % frod % set_r8_0 ('gfrac-h2o', gfrac(8))
!        call this % frod % set_r8_1 ('gbse', gbse(1:naxn-1))
        call this % frod % set_r8_1 ('fluxz', fluxz(1:naxn))
        call this % frod % set_r8_1 ('nodchf', nodchf(1:naxn))
        call this % frod % set_i4_1 ('ngastmp', ngastmp)
        call this % frod % set_r8_0 ('swd', swd(1))
        call this % frod % set_r8_1 ('oxideod', oxideod(1:naxn))
        call this % frod % set_r8_1 ('cexh2a', cexh2a(1:naxn))
!        call this % frod % set_r8_2 ('pazp', pazp)
        call this % frod % set_r8_1 ('radpel', radpel(1:naxn))
        call this % frod % set_r8_0 ('gappr0', gappr0(1))
        call this % frod % set_r8_1 ('butemp', butemp(1:naxn))
        call this % frod % set_r8_1 ('oxideid', oxideid(1:naxn))
        call this % frod % set_r8_0 ('spl', spl(1))
        call this % frod % set_r8_1 ('eppinp', eppinp(1:naxn))
        call this % frod % set_r8_1 ('techf', techf(1:naxn))
        call this % frod % set_i4_0 ('ncs', ncs(1))
        call this % frod % set_r8_1 ('tschf', tschf(1:naxn))
        call this % frod % set_r8_1 ('zelev', zelev(1:naxn))
        call this % frod % set_r8_1 ('fmesh', fmesh(1:naxn))
        call this % frod % set_r8_1 ('cmesh', cmesh(1:naxn))
