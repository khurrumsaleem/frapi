MODULE cont3d_frapcon
    ...
    TYPE cont3dsurf_type
        ...
        INTEGER(ipk), POINTER :: tnodes(:,:) ! Target surface nodes
        INTEGER(ipk) :: ncnodes    ! Number of contactor nodes
        INTEGER(ipk), POINTER :: cnodes(:)   ! Contactor nodes
    ...
    IF ((.NOT. ASSOCIATED(surf1)) .OR. (.NOT. ASSOCIATED(surf2))) THEN
        WRITE (ounit,FMT='(A,I0)') 'ERROR cannot find surfaces for 3D contact surface ',label
        lerror = .TRUE.
        CALL nlfemp_stop(0)
    END IF
                    ...
                    ELSE
                        ...
                        DO WHILE (ASSOCIATED(curre))
                            IF (curre%surf == currs%label) THEN
                                IF ((curre%node_labels(1) == nodes(1)) .AND. (curre%node_labels(5) == nodes(5))) THEN
                                    label = curre%label
                                    EXIT
                                END IF
                            END IF
    ...
    current => first_cont3d
    DO WHILE (ASSOCIATED(current))
        IF ((current%node_labels(5) == nodes(5)) .AND. (current%node_labels(4) == nodes(4)) .AND. &
          & (current%node_labels(3) == nodes(3)) .AND. (current%node_labels(2) == nodes(2)) .AND. &
    ...
    IF (nfound /= 5) THEN
        WRITE (ounit,FMT='(/,A,/)') 'ERROR incompatible NODES and CONT3D data'
        lerror = .TRUE.
        CALL nlfemp_stop(0)
    END IF
    ...
    END DO
    CALL cont3d_gap (x_node, new_cont3d%gap0, new_cont3d%nv, new_cont3d%tv, new_cont3d%xi0, shapef)

    ! closing of the contact
    xi_b = 1.0_r8k + cont3d_alpha_tol
    IF ((new_cont3d%gap0 < 0.0_r8k) .AND. (new_cont3d%xi0(1) > -xi_b) .AND. (new_cont3d%xi0(1) < xi_b) .AND. &
      & (new_cont3d%xi0(2) > -xi_b) .AND. (new_cont3d%xi0(2) < xi_b)) current%closed0 = .TRUE.
    ...
    !> square of distance from the target surface to the contactor node using Newtons method.
    !
    ...
    DO WHILE (dfnorm > 1.0e-10_r8k)
        ...
        df = 0.0_r8k
        DO id = 1, 3
            df(1) = df(1) + 2.0_r8k * (x_node(id,5) - ax(1,id)) * ax(2,id)
            df(2) = df(2) + 2.0_r8k * (x_node(id,5) - ax(1,id)) * ax(3,id)
        END DO
        ...
        DO id = 1, 3
            ...
            jac(2,1) = jac(2,1) + 2.0_r8k * (x_node(id,5) - ax(1,id)) * ax(4,id) - 2.0_r8k * ax(2,id) * ax(3,id)
        END DO
        jac(1,2) = jac(2,1)
    ...
    INTEGER(ipk) :: ip, in
    REAL(r8k) :: x_node(3,5), xi_b, shapef(4,4)
    REAL(r8k), POINTER :: pfact, gap, nv(:), tv(:,:), xi(:)
    ...
    DO WHILE (ASSOCIATED(current))
        ...
        xi_b = 1.0_r8k + cont3d_alpha_tol
        IF ((gap < 0.0_r8k) .AND. (xi(1) > -xi_b) .AND. (xi(1) < xi_b) .AND. (xi(2) > -xi_b) .AND. (xi(2) < xi_b)) THEN
            current%closed = .TRUE.
        END IF
    ...
    !> 3D contact stiffness matrix
    IMPLICIT NONE
    REAL(r8k), INTENT(IN) :: pfact
    REAL(r8k) ::   t1,    t2,    t3,    t4,    t5,    t8,   t11,   t12,   t13,   t15,   t19,   t25,   t30,   t32, &
      &           t33,   t38,   t44,   t46,   t47,   t50,   t51,   t52,   t53,   t54,   t55,   t60,   t61,   t64, &
      &           t65,   t68,   t71,   t72,   t73,   t75,   t78,   t82,   t84,   t85,   t96,   t99,  t110,  t113, &
      &          t117,  t118,  t119,  t120,  t127,  t128,  t129,  t133,  t134,  t138,  t141,  t144,  t145,  t146, &
      &          t150,  t153,  t156,  t157,  t160,  t163,  t170,  t177,  t178,  t179,  t182,  t185,  t186,  t187, &
      &          t191,  t194,  t197,  t198,  t199,  t203,  t206,  t209,  t214,  t221,  t228,  t230,  t234,  t235, &
      &          t239,  t243,  t244,  t248,  t252,  t258,  t260,  t261,  t273,  t274,  t277,  t284,  t287,  t290, &
      &          t291,  t301,  t306,  t313,  t317,  t320,  t323,  t326,  t329,  t333,  t336,  t339,  t346,  t351, &
      &          t358,  t365,  t370,  t377,  t382,  t383,  t395,  t396,  t399,  t403,  t413,  t423,  t428,  t432, &
      &          t435,  t438,  t442,  t445,  t448,  t451,  t454,  t461,  t468,  t473,  t480,  t487,  t492,  t497, &
      &          t501,  t503,  t504,  t516,  t517,  t533,  t543,  t546,  t549,  t553,  t556,  t559,  t563,  t566, &
      &          t569,  t570,  t575,  t582,  t589,  t594,  t601,  t608,  t614,  t616,  t617,  t629,  t630,  t646, &
      &          t650,  t653,  t656,  t659,  t662,  t666,  t669,  t672,  t673,  t680,  t685,  t692,  t699,  t704, &
      &          t711,  t716,  t717,  t729,  t730,  t740,  t743,  t746,  t750,  t753,  t756,  t759,  t762,  t763, &
      &          t770,  t777,  t782,  t789,  t796,  t801,  t806,  t810,  t812,  t813,  t825,  t826,  t829,  t836, &
      &          t839,  t842,  t846,  t849,  t852,  t853,  t858,  t865,  t872,  t877,  t884,  t891,  t897,  t899, &
      &          t900,  t912,  t913,  t916,  t923,  t926,  t929,  t930,  t940,  t945,  t952,  t959,  t964,  t971, &
      &          t976,  t977,  t989,  t993,  t997, t1007, t1017, t1022, t1029, t1036, t1041, t1046, t1050, t1052, &
      &         t1053, t1065, t1066, t1082, t1092, t1097, t1104, t1111, t1117, t1119, t1120, t1132, t1133, t1149, &
      &         t1156, t1161, t1168, t1173, t1174, t1186, t1200, t1207, t1212, t1213, t1217, t1218, t1219, t1220, &
      &         t1224
    REAL(r8k), DIMENSION(2), INTENT(IN) :: xi
    REAL(r8k), DIMENSION(3,5), INTENT(IN) :: x_node
    REAL(r8k), DIMENSION(15,15), INTENT(OUT) :: Ke
    ...
    t113 = t110 * t50
    t117 = (-0.25_r8k * t3 * t55 - t72 * t85 / 2.0_r8k + t96 * t78 * t54 - t99 * t85 / 2.0_r8k + &
      &     t110 * t82 * t54 - t113 * t85 / 2.0_r8k) * pfact
    t118 = t117 * t1
    t119 = t2 * t32
    t120 = t119 * t54
    ...
    t261 = 2 * t75 * t260
    t273 = (-t71 * t78 * t54 - t72 * t261 / 2.0_r8k - 0.25_r8k * t3 * t235 - t99 * t261 / 2.0_r8k + &
      &      t110 * t258 * t54 - t113 * t261 / 2.0_r8k) * pfact
    t274 = t273 * t1
    t277 = t133 * t261
    t284 = t2 * t258 * t54
    t287 = t145 * t261
    ...
    t383 = 2 * t75 * t382
    t395 = (-t71 * t82 * t54 - t72 * t383 / 2.0_r8k - t96 * t258 * t54 - t99 * t383 / 2.0_r8k - &
      &     0.25_r8k * t3 * t244 - t113 * t383 / 2.0_r8k) * pfact
    t396 = t395 * t1
    t399 = t145 * t383
    t403 = t395 * t60
    ...
    t504 = 2 * t75 * t503
    t516 = (-0.25_r8k * t61 * t55 - t72 * t504 / 2.0_r8k + t96 * t497 * t54 - t99 * t504 / 2.0_r8k + &
      &     t110 * t501 * t54 - t113 * t504 / 2.0_r8k) * pfact
    t517 = t516 * t60
    ...
    t617 = 2 * t75 * t616
    t629 = (-t71 * t497 * t54 - t72 * t617 / 2.0_r8k - 0.25_r8k * t61 * t235 - t99 * t617 / 2.0_r8k + &
      &     t110 * t614 * t54 - t113 * t617 / 2.0_r8k) * pfact
    t630 = t629 * t60
    ...
    t717 = 2 * t75 * t716
    t729 = (-t71 * t501 * t54 - t72 * t717 / 2.0_r8k - t96 * t614 * t54 - t99 * t717 / 2.0_r8k - &
      &     0.25_r8k * t61 * t244 - t113 * t717 / 2.0_r8k) * pfact
    t730 = t729 * t60
    t740 = -t64 * t501 * t54
    t743 = t178 * t717
    ...
    t813 = 2 * t75 * t812
    t825 = (-0.25_r8k * t65 * t55 - t72 * t813 / 2.0_r8k + t96 * t806 * t54 - t99 * t813 / 2.0_r8k + &
      &     t110 * t810 * t54 - t113 * t813 / 2.0_r8k) * pfact
    t826 = t825 * t60
    t829 = t178 * t813
    t836 = t64 * t806 * t54
    t839 = t186 * t813
    ...
    t900 = 2 * t75 * t899
    t912 = (-t71 * t806 * t54 - t72 * t900 / 2.0_r8k - 0.25_r8k * t65 * t235 - t99 * t900 / 2.0_r8k + &
      &     t110 * t897 * t54 - t113 * t900 / 2.0_r8k) * pfact
    t913 = t912 * t60
    t916 = t186 * t900
    t923 = t64 * t897 * t54
    t926 = t198 * t900
    ...
    t977 = 2 * t75 * t976
    t989 = (-t71 * t810 * t54 - t72 * t977 / 2.0_r8k - t96 * t897 * t54 - t99 * t977 / 2.0_r8k - &
      &     0.25_r8k * t65 * t244 - t113 * t977 / 2.0_r8k) * pfact
    t993 = t198 * t977
    t997 = t989 * t1
    ...
    t1053 = 2 * t75 * t1052
    t1065 = (-0.25_r8k * t68 * t55 - t72 * t1053 / 2.0_r8k + t96 * t1046 * t54 - t99 * t1053 / 2.0_r8k + &
      &      t110 * t1050 * t54 - t113 * t1053 / 2.0_r8k) * pfact
    t1066 = t1065 * t1
    ...
    t1120 = 2 * t75 * t1119
    t1132 = (-t71 * t1046 * t54 - t72 * t1120 / 2.0_r8k - 0.25_r8k * t68 * t235 - t99 * t1120 / 2.0_r8k + &
      &      t110 * t1117 * t54 - t113 * t1120 / 2.0_r8k) * pfact
    t1133 = t1132 * t1
    ...
    t1174 = 2.0_r8k * t75 * t1173
    t1186 = (-t71 * t1050 * t54 - t72 * t1174 / 2.0_r8k - t96 * t1117 * t54 - t99 * t1174 / 2.0_r8k - &
      &      0.25_r8k * t68 * t244 - t113 * t1174 / 2.0_r8k) * pfact
...
10  CONTINUE
    WRITE (ounit,FMT='(/,A,/)') 'ERROR while reading CONT3D database'
    lerror = .TRUE.
    CALL nlfemp_stop(0)
