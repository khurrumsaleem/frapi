program test_mcs
    ...
    do i_cycle = 1, n_cycle
        ...
        do i_frod = 1, n_frod
            ...
            call frod(i_frod) % set_array("axial mesh thickness, cm", thickness_FRPCN)
        ...
        do i_bu_step = n_bu_steps(i_cycle), n_bu_steps(i_cycle+1)
            ...
            do i_frod = 1, n_frod
                ...
                do i_iter = 1, n_iter
                    ...
                    power_FRPCN = 181.930615453187d-6
                    ...
                    if(i_bu_step == 1) then
                        ...
                        write(*,*) 'init fuel rod # ', i_frod
                        call frod(i_frod) % init()
                        call frod(i_frod) % save()
                    else
                        ! DO TRIAL TIME STEP
                        write(*,*) 'next fuel rod # ', i_frod
                    ...
                    call frod(i_frod) % get_array('cladding total hoop strain, %', hoop_strain)
